...
class Ui_PhotoShow(QThread):
    ...
    def InitTranShow(self):
        ...
        TranspscrollAreaformLayout['TranspFinsh'] = [0,transmitui.verticalLayout_4, transmitui.scrollAreaWidgetContents_6,transmitui.label_10,transmitui.pushButton_6]
