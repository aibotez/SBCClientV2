...
# Form implementation generated from reading ui file 'ForPass.ui'
#
...
"}")
        ...
        self.label_8.setStyleSheet("#label_6{\n"
"    color:#ff0000;\n"
"}")
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_10.setPlaceholderText(_translate("Dialog", "设置新密码"))
        self.label_10.setText(_translate("Dialog", "con"))
        self.lineEdit_7.setPlaceholderText(_translate("Dialog", "再次输入密码"))
        self.label_4.setText(_translate("Dialog", "登录"))
        self.pushButton.setText(_translate("Dialog", "设置新密码"))
